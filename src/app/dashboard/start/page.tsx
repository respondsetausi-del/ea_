    ...
    <div className="max-w-xl mx-auto space-y-6">
      ...
      {!counts ? (
        ...
        <>
            ...
            {STEPS.map((step, i) => {
              ...
              return (
                <div
                  ...
                  style={{
                    background: isCurrent ? CARD : isDone ? "rgba(10,132,255,0.04)" : "rgba(255,255,255,0.02)",
                    border: `1px solid ${isCurrent ? "rgba(10,132,255,0.25)" : isDone ? "rgba(10,132,255,0.12)" : BORDER}`,
                ...
                >
                  <div
                    ...
                    style={{
                      background: isDone ? "rgba(10,132,255,0.12)" : isCurrent ? ACCENT : "rgba(255,255,255,0.06)",
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {isDone && (
                        <span className="text-[9px] font-bold px-2 py-0.5 rounded-full" style={{ background: "rgba(10,132,255,0.12)", color: ACCENT }}>DONE</span>
                      )}
                    </div>
          ...
          {allDone && (
            <div className="rounded-2xl p-5 text-center" style={{ background: "rgba(10,132,255,0.06)", border: "1px solid rgba(10,132,255,0.15)" }}>
          ...
          <div className="flex items-center justify-between pt-2">
            ...
            <button
              ...
              style={allDone
                ? { background: ACCENT, color: "#000", boxShadow: "0 4px 16px rgba(10,132,255,0.3)" }

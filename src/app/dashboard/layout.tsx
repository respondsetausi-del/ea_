  ...
  return (
    <div className="flex min-h-screen" style={{ background: BG }}>
      ...
      <aside
        ...
        style={{ background: CARD, borderRight: "1px solid rgba(10,132,255,0.06)" }}
      >
        ...
        <div className="px-3 pb-4 pt-3 space-y-2" style={{ borderTop: "1px solid rgba(10,132,255,0.06)" }}>
      ...
      <main className="flex-1 flex flex-col min-w-0">
        <header
          ...
          style={{ background: "rgba(22,27,34,0.8)", backdropFilter: "blur(12px)", borderBottom: "1px solid rgba(10,132,255,0.06)" }}
        >

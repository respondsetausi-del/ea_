  ...
  const NavItem = ({ href, label, icon: Icon, isAdmin }: { href: string; label: string; icon: any; isAdmin?: boolean }) => {
    ...
    return (
      <Link
        ...
        style={{
          background: active ? "rgba(61,224,92,0.1)" : "transparent",
  ...
  return (
    <div className="flex min-h-screen" style={{ background: BG }}>
      ...
      <aside
        ...
        style={{ background: CARD, borderRight: "1px solid rgba(61,224,92,0.06)" }}
      >
        <div className="px-5 pt-6 pb-5 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ background: "rgba(61,224,92,0.12)" }}>
        ...
        <div className="px-3 pb-4 pt-3 space-y-2" style={{ borderTop: "1px solid rgba(61,224,92,0.06)" }}>
      ...
      <main className="flex-1 flex flex-col min-w-0">
        <header
          ...
          style={{ background: "rgba(22,27,34,0.8)", backdropFilter: "blur(12px)", borderBottom: "1px solid rgba(61,224,92,0.06)" }}
        >

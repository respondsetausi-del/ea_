...
export async function GET(req: NextRequest) {
  ...
  const [{ data: distributors }, { data: eas }, { data: appUsers }, { data: adminEmails }] = await Promise.all([
  ...
  return NextResponse.json({ stats, distributors: distributorRows, appUsers: appUserRows, admins, mqtt });
}
